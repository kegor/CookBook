...
namespace CookBookWorkerRole
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("CookBookWorker entry point called");
            ...
            while (true)
            {
                ...
                catch (StorageException e)
                {
                    ...
                    Trace.TraceError("Exception in CookBookWorker: '{0}'", e.Message);
        ...
        private void ProcessQueueMessage(CloudQueueMessage msg)
        {
            ...
            var recipeId = int.Parse(msg.AsString);
            Recipe recipe = db.Recipes.Find(recipeId);
            if (recipe == null)
            {
                throw new Exception(String.Format("RecipeId {0} not found, can't create thumbnail", recipeId.ToString()));
            }
            ...
            recipe.ThumbnailURL = outputBlob.Uri.ToString();
            db.SaveChanges();
            Trace.TraceInformation("Updated thumbnail URL in database: {0}", recipe.ThumbnailURL);
        ...
        public override bool OnStart()
        {
            ...
            var dbConnString = CloudConfigurationManager.GetSetting("CookBookDbConnectionString");
            db = new CookBookContext(dbConnString);
